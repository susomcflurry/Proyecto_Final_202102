    ...
    <header>
        <div class="row">
            ...
            <div class="col-6 topnav">
                <ul>
                    <li><a href="' . base_url() . 'home"><span class="material-icons">home</span>Mis Recursos</a></li>
                    <li><a href="' . base_url() . 'estadisticas"><span class="material-icons">inventory_2</span>Tesauros</a></li>
